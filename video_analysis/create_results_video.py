...
class ResultVideo():#PostProcessing):
    def __init__(self, data_path, video_path, calibration_model, blobs_mat):
    ...
    def present_results_on_frame(self, frame, frame_num,blobs_labels):
        ...
        #remove nan rows from the blobs_labels
...
def track_ants(matrix_path):
    import matlabengine
    matlab_script_path = "Z:\\Dor_Gabay\\ThesisProject\\scripts\\munkres_tracker\\ants_tracking.m"
    eng = matlabengine.start_matlab()
    eng.workspace['matrix_path'] = matrix_path
    eng.run_script(matlab_script_path)
    eng.quit()
    # import scipy
    # tracking_file_path = matrix_path + "tracking_data.mat"
    # blobs_mat = scipy.io.loadmat(tracking_file_path, squeeze_me=True, struct_as_record=False)["tracked_blobs_matrix"]
...
if __name__ == "__main__":
    ...
    tracking_file_path = "Z:\\Dor_Gabay\\ThesisProject\\data\\videos\\15\\tracking_data.mat"
    #load matlab file
    import scipy
    blobs_mat = scipy.io.loadmat(tracking_file_path, squeeze_me=True, struct_as_record=False)["tracked_blobs_matrix"]
    ...
    data_path = "Z:\\Dor_Gabay\\ThesisProject\\data\\videos\\15\\"
    video_path = "Z:\\Dor_Gabay\\ThesisProject\\data\\videos\\15.9.22\\plus0.3mm_force\\S5280004.MP4"
    ...
    ResultVideo(data_path, video_path,calibration_model, blobs_mat)
